...
const Resume = () => (
  <div className={styles.cvBody}>
    ...
    <div className={styles.cv}>
      ...
      <ul>
        <li>
          Growing the technical practice at{' '}
          <a href="//springload.co.nz/" target="_blank">
            Springload
          </a>
        </li>
        <li>
          Launching <a href="https://votelocal.nz">Vote Local</a> for the 2016
          local body elections
        </li>
        <li>
          Winning the Information category at the{' '}
          <a href="http://idealog.co.nz/tech/2016/08/kiwi-companies-bring-home-bacon-internet-awards">
            2016 ANZIA awards
          </a>
        </li>
        <li>
          Helping improve health outcomes in South Africa with the{' '}
          <a href="//www.springload.co.nz/blog/wagtail-cape-town-sprint/">
            Wagtail CMS
          </a>{' '}
        ...
        <li>
          Best Awards – Gold and Purple Pin for{' '}
          <a target="_blank" href="http://homehunter.co.nz/">
            HomeHunter
          </a>
          , 2014
        </li>
        <li>
          Developing a new, responsive{' '}
          <a target="_blank" href="http://www.kiwibank.co.nz/personal-banking/">
            Personal Banking
          </a>{' '}
          section for Kiwibank
        </li>
        <li>
        ...
        <li>
          ...
          <a
            target="_blank"
            href="http://blog.joshbarr.com/2011/01/akzidenz-baby/"
          >
            Akzidenz Baby!
          </a>
          , 2009
      ...
      <h3 className="">Employment History</h3>
      ...
      <p className="date">Nov 2016 - July 2018</p>
      <p>
        Architected and implemented new navigation for Xero's 18 customer-facing
        web applications. Touted as the "single biggest change to Xero in
        years".
      </p>
      <p>
        Created "good-by-default" libraries for dev teams to implement OpenId
        Connect authentication.
      </p>
      <p>
        Modernised Xero's frontend tooling to use Webpack, saving 100
        hours/month in build server time.
      </p>

      <h4>Technical Director, Springload</h4>
      <p className="date">Nov 2015 - Nov 2016</p>
      <p>
        Alongside Richard McMillan, I am responsible for running the technical
        practice at Springload. Over 2014-2016, we've transformed Springload's
        technical culture, initiating continuous integration, continuous
        deployment, and unit testing practices. We've standardised environments
        and moved the studio to Python and Node on AWS. As a member of the NZ
        Institute of Directors, I'm passionate about continuously improving as a
        leader.
      </p>

      <h4>Designer, GoodWorld</h4>
      <p className="date">Aug 2014 - Feb 2015</p>
      <p>
        Working with the Wellington-based development team and Washington-based
        business team, I helped take GoodWorld through a successful funding
        round and into Fast Company's{' '}
      ...
      <p className="date">Dec 2013 - Nov 2015</p>
      <p>
      ...
      <p className="date">Jan 2013 - Dec 2013</p>
      <p>
      ...
      <p className="date">Nov 2011 - Jan 2013</p>
      <p>
        I was responsible for user experience and design on my allocated
        projects, under the direction of Andrew Hovey. Highlights include
      ...
      <p className="date">July 2011 – October 2011 (fixed term)</p>
      <p>
      ...
      <p className="date">February 2011 - June 2011 (fixed term)</p>
      <p>
      ...
      <p className="date">October 2009 – February 2010</p>
      <p>
      ...
      <p className="date">Massey University Wellington, 2006-2009</p>
      <p>
      ...
      <p className="noprint footnote">
        <sup id="note1">1</sup> Matt Soar’s dissertation,{' '}
        <a
          target="_blank"
          href="http://mattsoar.com/dissertation/GraphicDesignGraphicDissent.pdf"
        >
          Graphic Design/Graphic Dissent
        </a>{' '}
        (2002) inspired in me a love for work with social or civic benefit. Soar
        suggests that designers often produce work that’s only consumed by other
        cultural elites. As Bobbi Newman writes,{' '}
        <em>
          If it’s inaccessible to the poor it’s neither radical nor
          revolutionary
        </em>
        .
      </p>
      <p className="noprint">
        <a href="joshbarr-technical-director-2016-09.pdf" title="">
