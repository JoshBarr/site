...
const IndexPage = ({ data }) => (
  <Layout theme="theme--hero">
    <SEO
      title="Home"
      keywords={[`frontend development`, `architecture`, `react`]}
    />
    <div className="hero theme-text">
      <div className="container">
        ...
        <p className="hero__subtitle font-display theme-display-weight">
          ...
          from Wellington, New Zealand. I help companies build scalable, secure
      ...
      <div className="container">
        <div className="section">
          ...
          <Link className="theme-link__brand" to="/articles">
            All articles
          </Link>
        </div>
      </div>
